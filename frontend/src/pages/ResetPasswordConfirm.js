...
const ResetPasswordConfirm = () => {
  ...
  const {resetPasswordConfirm, resetPasswordStatus, spinner} = useContext(AuthContext)
  ...
  return (
    <div className='h-[80vh] flex justify-center items-center'>
      ...
      {/* {loginStatus.alert &&
        ...
        {resetPasswordStatus===204 &&
          <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
            <span class="font-medium">Success alert!</span> Your password changed successfully. <Link to='/login' className='text-blue-500 hover:underline'>Login</Link> 
          </div>
        }
      </form>
    </div>
